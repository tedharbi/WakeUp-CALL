...
<body class="">
    ...
    <div class="containercart">
        <header>
            <div class="titlecart"><a href="${pageContext.request.contextPath}/MenuHot" class"link">PASTRY  </a></div>
            <div class="icon-cart">
    ...
    <script src="${pageContext.request.contextPath}/js/PASTRY.js"></script>
