...
<body class="">
    ...
    <div class="containercart">
        <header>
            <div class="titlecart"><a href="${pageContext.request.contextPath}/MenuHot" class"link">HOT DRINKS  </a></div>
            <div class="icon-cart">
    ...
    <script src="${pageContext.request.contextPath}/js/MenuHot.js"></script>
