    ...
    <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav testing">
          ...
          <li class="nav-item">
            <a class="nav-link tm-nav-link" href="${pageContext.request.contextPath}/login"><i class="fa-solid fa-user"></i
            ></a>
          </li>
          <li class="nav-item">
            <a class="nav-link tm-nav-link" href="${pageContext.request.contextPath}/inventory"
